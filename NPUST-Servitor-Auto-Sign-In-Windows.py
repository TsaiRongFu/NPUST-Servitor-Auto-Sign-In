...
def main():
    ...
    layout = [[sg.Text('Theme Browser')],
            [sg.Text('Click a Theme color')],
            [sg.Listbox(values=sg.theme_list(), size=(20, 12), key='-LIST-', enable_events=True)],
            [sg.Button("Open Window", key="open")],[sg.Button('Exit')]]

    window = sg.Window('Theme Browser', layout, icon = iconBase64)
